/*******************************************************************************
 * NestedListsActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.ui.nestedlists.NestedListsView.Presenter;
...
public class NestedListsActivity extends KitchenSinkActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        NestedListsViewImpl view = Util.getNestedListView();
