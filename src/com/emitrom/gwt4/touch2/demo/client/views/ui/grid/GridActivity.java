/*******************************************************************************
 * GridActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.ui.grid.GridView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class GridActivity extends KitchenSinkActivity implements Presenter {

    public GridActivity(GridViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        GridViewImpl view = Util.getGridView();
