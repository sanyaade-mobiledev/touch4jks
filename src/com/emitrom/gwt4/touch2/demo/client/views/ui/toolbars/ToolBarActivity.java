/*******************************************************************************
 * ToolBarActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.ui.toolbars.ToolBarView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class ToolBarActivity extends KitchenSinkActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        ToolBarViewImpl view = Util.getToolbarView();
