/*******************************************************************************
 * FadeActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch.client.fx.layout.card.Fade;
...
import com.emitrom.gwt4.touch2.demo.client.views.animations.fade.FadeView.Presenter;
...
public class FadeActivity extends KitchenSinkActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        FadeViewImpl view = Util.getFadeView();
    	view.setPresenter(this);
    	Fade fade = new Fade();
    	fade.setDuration(2000);
    	ViewPort.get().setAnimation(fade);
