/*******************************************************************************
 * ContactsActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.device.contacts.ContactsView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class ContactsActivity extends KitchenSinkActivity implements Presenter {

    private ContactsViewImpl view;
    
    public ContactsActivity(ContactsViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        view = Util.getContactsView();
