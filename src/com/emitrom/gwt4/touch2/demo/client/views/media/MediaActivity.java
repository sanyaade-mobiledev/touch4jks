/*******************************************************************************
 * MediaActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.touch4j2.demo.client.views.media.MediaView.Presenter;
...
public class MediaActivity extends KitchenSinkActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        MediaViewImpl view = Util.getMediaView();
