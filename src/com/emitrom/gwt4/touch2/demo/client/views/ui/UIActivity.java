/*******************************************************************************
 * UIActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.touch4j2.demo.client.views.ui.UIView.Presenter;
...
public class UIActivity extends KitchenSinkActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        UIViewImpl view = Util.getUIView();
