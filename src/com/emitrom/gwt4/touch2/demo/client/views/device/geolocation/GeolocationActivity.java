/*******************************************************************************
 * GeolocationActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.device.geolocation.GeolocationView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class GeolocationActivity extends KitchenSinkActivity implements Presenter {

    private GeolocationViewImpl view;
    
    public GeolocationActivity(GeolocationViewPlace place, ClientFactory clientFactory) {
