/*******************************************************************************
 * ScatterChartsActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.charts.scatter.ScatterChartsView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class ScatterChartsActivity extends KitchenSinkActivity implements Presenter {

    public ScatterChartsActivity(ScatterChartsViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        ScatterChartsViewImpl view = Util.getScatterChartsView();
