/*******************************************************************************
 * BarChartsActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.charts.bar.BarChartsView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class BarChartsActivity extends KitchenSinkActivity implements Presenter {

    public BarChartsActivity(BarChartsViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        BarChartsViewImpl view = Util.getBarChartsView();
