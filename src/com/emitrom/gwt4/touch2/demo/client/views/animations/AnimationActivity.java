/*******************************************************************************
 * AnimationActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
public class AnimationActivity extends KitchenSinkActivity implements View.Presenter {

    public AnimationActivity(AnimationViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        AnimationViewImpl view = Util.getAnimationView();
