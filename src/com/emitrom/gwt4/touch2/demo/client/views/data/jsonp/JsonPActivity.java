/*******************************************************************************
 * JsonPActivity.java is part of the Kitchen Sink (for Touch4j 2.2)
 * 
...
import com.emitrom.gwt4.touch2.demo.client.views.data.jsonp.JsonPView.Presenter;
import com.google.gwt.event.shared.EventBus;
import com.google.gwt.user.client.ui.AcceptsOneWidget;

public class JsonPActivity extends KitchenSinkActivity implements Presenter {

    private JsonPViewImpl view;
    
    public JsonPActivity(JsonPViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        view = Util.getJsonPView();
